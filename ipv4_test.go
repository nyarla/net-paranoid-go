...
func TestIPv4(t *testing.T) {
	...
	tests := []task{
		...
		{true, `172.16.0.1`, IPv4PrivateClassB},
		{true, `172.31.255.255`, IPv4PrivateClassB},
		{false, `172.32.0.1`, IPv4PrivateClassB},

		{false, `192.165.255.255`, IPv4PrivateClassC},
		{true, `192.168.0.1`, IPv4PrivateClassC},
		{true, `192.168.255.255`, IPv4PrivateClassC},
		{false, `192.169.0.1`, IPv4PrivateClassC},
